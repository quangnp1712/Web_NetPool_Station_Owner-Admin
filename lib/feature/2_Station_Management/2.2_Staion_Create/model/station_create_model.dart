...
class StationCreateModel {
  ...
  factory StationCreateModel.fromMap(Map<String, dynamic> map) {
    return StationCreateModel(
  ...
  factory StationCreateModel.fromJson(Map<String, dynamic> source) =>
      StationCreateModel.fromMap(source);
}
